                ...
                {isMobileSM ? (
                    <div suppressHydrationWarning className="relative min-w-full min-h-screen w-full h-screen overflow-hidden">
                        ...
                        <BackgroundImage
                            ...
                            imageDarkThemeSrc={"/images/CNTRSTOP-darkmode.png"}
                            className="animate-reversePulse absolute top-0 left-0"
                        />
                        <BackgroundImage
                            ...
                            className="z-20"
                        />
                        <div className="flex h-screen flex-col gap-[21px] items-center justify-center relative w-full mt-5">
                            ...
                            <Card
                                size="sm"
                                position="center_sm"
                                className=" w-[89vw] h-auto pt-[55px] pb-0 rounded-[6px] self-center"
                            >
                            ...
                            <div className="w-[300px] h-auto py-0 overflow-auto self-center">
                                <ArtistCard />
                            </div>
                            {/* </Card> */}
