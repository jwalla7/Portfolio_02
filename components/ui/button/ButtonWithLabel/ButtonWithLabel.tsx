    ...
    return (
        <div className="flex justify-start items-start gap-[21px] group">
            <button
                ...
                box-border border-0 grow-0 shrink-0 justify-center items-center w-[3.9121265377855887vw] h-[6.9780564263323vh] relative gap-[13px] p-[9px] rounded-[12.4px] backdrop-blur-[12.4px]"
                {...props}
                ref={navButtonRef}
            >
                {icon}
