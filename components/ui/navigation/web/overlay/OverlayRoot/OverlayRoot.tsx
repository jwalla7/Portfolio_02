...
export const OverlayRoot = forwardRef<HTMLDivElement, OverlayRootProps>(({ children, overlayRef, sidebarRef }, ref) => {
    return (
            ...
            <div className={overlayStylesLayer_1({ background: "default" })}>
                <div className={overlayStylesLayer_2({ background: "none" })}>
                    <div className={overlayStylesLayer_3({ background: "none" })}>
                        <OverlayNav overlayRef={overlayRef} sidebarRef={sidebarRef}>
                            {children}
                        </OverlayNav>
                    </div>
                </div>
