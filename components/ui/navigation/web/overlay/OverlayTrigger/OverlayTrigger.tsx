        ...
        <NavigationMenu.Root className="w-screen h-[209.5vh]" delayDuration={0} orientation="vertical">
            <NavigationMenu.Item className="w-screen h-full list-none">
                <NavigationMenu.Trigger asChild>
                    <div className={cn(overlayTriggerStyles({ className }))} ref={ref} />
                </NavigationMenu.Trigger>
                <NavigationMenu.Content className={clsx(className, "h-screen")}>
                    <OverlayRoot overlayRefProps={displayStateRef}>{children}</OverlayRoot>
