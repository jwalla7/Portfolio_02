...
var pn,
    ...
    Mi = !0;
typeof y < "u" &&
    (({ FORCE_COLOR: pn, NODE_DISABLE_COLORS: Oi, NO_COLOR: ki, TERM: Di } = y.env || {}), (Mi = y.stdout && y.stdout.isTTY));
...
var et = 9e15,
    ...
    En = { precision: 20, rounding: 4, modulo: 1, toExpNeg: -7, toExpPos: 21, minE: -et, maxE: et, crypto: !1 },
    oo,
    Ce,
    _ = !0,
    Pr = "[DecimalError] ",
...
C.toExponential = function (e, t) {
    ...
    return (
        e === void 0
            ? (r = me(n, !0))
            : (ie(e, 0, Me), t === void 0 ? (t = i.rounding) : ie(t, 0, 8), (n = O(new i(n), e + 1, t)), (r = me(n, !0, e + 1))),
...
var U = (function () {
    ...
    return function (n, i, o, s, a, l) {
        ...
        if (
            ($[h] > (Z[h] || 0) && g--,
            o == null ? ((J = o = ur.precision), (s = ur.rounding)) : a ? (J = o + (n.e - i.e) + 1) : (J = o),
            J < 0)
        )
            (q.push(1), (A = !0));
        else {
                    ...
                    ((v = 0),
                        ...
                        u < 0
                            ? ((ae = D[0]),
                              ...
                              M < I && R.unshift(0),
                              r(D, R, I, l),
                              u == -1 && ((I = D.length), (u = t($, D, ue, I)), u < 1 && (v++, r(D, ue < I ? lr : $, I, l))),
                              (I = D.length))
                            : u === 0 && (v++, (D = [0])),
                        (q[h++] = v),
...
function xn(e, t) {
    ...
    for (n = ((Math.log(Q(2, h)) / Math.LN10) * 2 + 5) | 0, l += n, r = o = s = new v(1), v.precision = l; ; ) {
        if (((o = O(o.times(e), l, 1)), (r = r.times(++g)), (a = s.plus(U(o, r, l, 1))), Y(a.d).slice(0, l) === Y(s.d).slice(0, l))) {
            ...
            if (t == null)
                if (u < 3 && kt(s.d, l - n, S, u)) ((v.precision = l += 10), (r = o = a = new v(1)), (g = 0), u++);
    ...
    if ((A ? (ie(r, 1, Me), n === void 0 ? (n = S.rounding) : ie(n, 0, 8)) : ((r = S.precision), (n = S.rounding)), !e.isFinite()))
        ...
        for (
            g = me(e),
                ...
                s >= 0 &&
                    ((g = g.replace(".", "")), (v = new S(1)), (v.e = g.length - s), (v.d = wr(me(v), 10, i)), (v.e = v.d.length)),
                h = wr(g, 10, i),
                o = l = h.length;
            h[--l] == 0;
        )
        ...
        if (!h[0]) g = A ? "0p+0" : "0";
            ...
            if (
                (s < 0 ? o-- : ((e = new S(e)), (e.d = h), (e.e = o), (e = U(e, v, r, n, 0, i)), (h = e.d), (o = e.e), (u = oo)),
                (s = h[r]),
                (a = i / 2),
                (u = u || h[r + 1] !== void 0),
                (u =
...
function Fr({ args: e, errors: t, errorFormat: r, callsite: n, originalMethod: i, clientVersion: o, globalOmit: s }) {
    ...
    let { message: l, args: u } = Nr(a, r),
        g = st({ message: l, callsite: n, originalMethod: i, showColors: r === "pretty", callArguments: u });
...
function Gt({ error: e, user_facing_error: t }, r, n) {
    return t.error_code
        ? new W(rc(t, n), { code: t.error_code, clientVersion: r, meta: t.meta, batchRequestIdx: t.batch_request_idx })
...
var is = (e) => (Array.isArray(e) ? e : e.split(".")),
    ...
    os = (e, t, r) => is(t).reduceRight((n, i, o, s) => Object.assign({}, Bn(e, s.slice(0, o)), { [i]: n }), r);
function uc(e, t) {
...
function $n(e, t) {
    let r = e._extensions.getAllModelExtensions(t) ?? {},
        n = [gc(e, t), yc(e, t), Jt(r), te("name", () => t), te("$name", () => t), te("$parent", () => e._appliedParent)];
    return be({}, n);
}
function gc(e, t) {
    let r = ye(t),
...
async function Kn(e, t = {}) {
    ...
    return new Promise((s, a) => {
        let l = r.request(e, n, (u) => {
            ...
            (g >= 301 && g <= 399 && h && (h.startsWith("http") === !1 ? s(Kn(`${o}${h}`, t)) : s(Kn(h, t))),
