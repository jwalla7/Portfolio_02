...
${c}`);
    ...
    return t === "linux" && o && i
        ? `${o}-openssl-${i}`
        : (t !== "linux" && Br(`Prisma detected unknown OS "${t}" and may not work as expected. Defaulting to "linux".`),
...
var bt = 9e15,
    ...
    vi = { precision: 20, rounding: 4, modulo: 1, toExpNeg: -7, toExpPos: 21, minE: -bt, maxE: bt, crypto: !1 },
    xs,
    Ne,
    x = !0,
    on = "[DecimalError] ",
...
m.toExponential = function (e, t) {
    ...
    return (
        e === void 0
            ? (r = we(n, !0))
            : (ie(e, 0, ze), t === void 0 ? (t = i.rounding) : ie(t, 0, 8), (n = y(new i(n), e + 1, t)), (r = we(n, !0, e + 1))),
...
m.toSignificantDigits = m.toSD = function (e, t) {
    var r = this,
        n = r.constructor;
    return (
        e === void 0 ? ((e = n.precision), (t = n.rounding)) : (ie(e, 1, ze), t === void 0 ? (t = n.rounding) : ie(t, 0, 8)),
        y(new n(r), e, t)
    );
};
m.toString = function () {
...
function vc(e, t) {
    ...
    ((n = t.d.length),
        n < 32 ? ((r = Math.ceil(n / 3)), (i = (1 / an(4, r)).toString())) : ((r = 16), (i = "2.3283064365386962890625e-10")),
        (e.precision += r),
...
var N = (function () {
    ...
    return function (n, i, o, s, a, l) {
        ...
        if (
            (_[p] > (Y[p] || 0) && c--,
            o == null ? ((ae = o = Lr.precision), (s = Lr.rounding)) : a ? (ae = o + (n.e - i.e) + 1) : (ae = o),
            ae < 0)
        )
            (S.push(1), (g = !0));
        else {
                    ...
                    ((d = 0),
                        ...
                        u < 0
                            ? ((me = C[0]),
                              ...
                              O < E && h.unshift(0),
                              r(C, h, E, l),
                              u == -1 && ((E = C.length), (u = t(_, C, z, E)), u < 1 && (d++, r(C, z < E ? dt : _, E, l))),
                              (E = C.length))
                            : u === 0 && (d++, (C = [0])),
                        (S[p++] = d),
...
function we(e, t, r) {
    ...
    return (
        t
            ? (r && (n = r - s) > 0 ? (o = o.charAt(0) + "." + o.slice(1) + We(n)) : s > 1 && (o = o.charAt(0) + "." + o.slice(1)),
              (o = o + (e.e < 0 ? "e" : "e+") + e.e))
            : i < 0
...
function Ci(e, t) {
    ...
    if (((t = t.slice(n, i)), t)) {
        ...
        for (; n--; ) t += "0";
        (e.d.push(+t),
            x && (e.e > e.constructor.maxE ? ((e.d = null), (e.e = NaN)) : e.e < e.constructor.minE && ((e.e = 0), (e.d = [0]))));
    } else ((e.e = 0), (e.d = [0]));
    return e;
}
function Tc(e, t) {
...
function Si(e, t, r, n) {
    var i,
        ...
        f = e.constructor,
        g = r !== void 0;
    if ((g ? (ie(r, 1, ze), n === void 0 ? (n = f.rounding) : ie(n, 0, 8)) : ((r = f.precision), (n = f.rounding)), !e.isFinite()))
        c = Is(e);
    else {
        for (
            c = we(e),
                ...
                s >= 0 &&
                    ((c = c.replace(".", "")), (d = new f(1)), (d.e = c.length - s), (d.d = en(we(d), 10, i)), (d.e = d.d.length)),
                p = en(c, 10, i),
                o = l = p.length;
            p[--l] == 0;
        )
        ...
        if (!p[0]) c = g ? "0p+0" : "0";
            ...
            if (
                (s < 0 ? o-- : ((e = new f(e)), (e.d = p), (e.e = o), (e = N(e, d, r, n, 0, i)), (p = e.d), (o = e.e), (u = xs)),
                (s = p[r]),
                (a = i / 2),
                (u = u || p[r + 1] !== void 0),
                (u =
...
var yp = { red: ce, gray: Gt, dim: Oe, bold: H, underline: X, highlightSource: (e) => e.highlight() },
    bp = { red: (e) => e, gray: (e) => e, dim: (e) => e, bold: (e) => e, underline: (e) => e, highlightSource: (e) => e };
...
function wn({ args: e, errors: t, errorFormat: r, callsite: n, originalMethod: i, clientVersion: o, globalOmit: s }) {
    ...
    let { message: l, args: u } = En(a, r),
        c = Tt({ message: l, callsite: n, originalMethod: i, showColors: r === "pretty", callArguments: u });
...
function _i(e, t) {
    e === void 0 &&
        t.isPreviewFeatureOn("strictUndefinedChecks") &&
        t.throwValidationError({ kind: "InvalidSelectionValue", selectionPath: t.getSelectionPath(), underlyingError: oa });
}
var Di = class e {
    constructor(t) {
        this.params = t;
...
function st({ error: e, user_facing_error: t }, r, n) {
    return t.error_code
        ? new V(fd(t, n), { code: t.error_code, clientVersion: r, meta: t.meta, batchRequestIdx: t.batch_request_idx })
...
function Lt(e = {}) {
    let t = Ad(e);
    return Object.entries(t).reduce((n, [i, o]) => (ba[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o), n), {
        select: {},
    });
}
function Ad(e = {}) {
...
var Ta = (e) => (Array.isArray(e) ? e : e.split(".")),
    ...
    Ra = (e, t, r) => Ta(t).reduceRight((n, i, o, s) => Object.assign({}, Gi(e, s.slice(0, o)), { [i]: n }), r);
function _d(e, t) {
...
function Ji(e, t) {
    let r = e._extensions.getAllModelExtensions(t) ?? {},
        n = [qd(e, t), Vd(e, t), gr(r), re("name", () => t), re("$name", () => t), re("$parent", () => e._appliedParent)];
    return Se({}, n);
}
function qd(e, t) {
    let r = Te(t),
...
function An({ visitor: e, result: t, args: r, runtimeDataModel: n, modelName: i }) {
    ...
    let o = e(t, i, r) ?? t;
    return (
        r.include && ka({ includeOrSelect: r.include, result: o, parentModelName: i, runtimeDataModel: n, visitor: e }),
        r.select && ka({ includeOrSelect: r.select, result: o, parentModelName: i, runtimeDataModel: n, visitor: e }),
        o
    );
}
...
function br(e) {
    ...
    if (typeof e == "object") {
        ...
        for (let r in e)
            r === "__proto__"
                ? Object.defineProperty(t, r, { value: br(e[r]), configurable: !0, enumerable: !0, writable: !0 })
                : (t[r] = br(e[r]));
        return t;
    }
    Fe(e, "Unknown value");
...
async function to(e, t = {}) {
    ...
    return new Promise((s, a) => {
        let l = r.request(e, n, (u) => {
            ...
            (c >= 301 && c <= 399 && p && (p.startsWith("http") === !1 ? s(to(`${o}${p}`, t)) : s(to(p, t))),
...
function dm(e) {
    ...
    let r = dl.default.toNamespacedPath(e),
        ...
        i = 0;
    return (
        process.platform !== "win32" && (i = so.default.constants.dlopen.RTLD_LAZY | so.default.constants.dlopen.RTLD_DEEPBIND),
...
${a.backtrace}`,
        ...
        async requestBatch(t, { transaction: r, traceparent: n }) {
            ...
            (await this.start(),
                ...
                (this.executingQueryPromise = this.engine.query(this.lastQuery, JSON.stringify({ traceparent: n }), pl(r))));
...
function hl({ copyEngine: e = !0 }, t) {
    ...
    e &&
        n &&
        tr("recommend--no-engine", "In production, we recommend using `prisma generate --no-engine` (See: `prisma generate --help`)");
    ...
    class t {
        constructor(n) {
            ...
            let o = {
                    ...
                    schemaEnvPath:
                        e.relativeEnvPaths.schemaEnvPath && Fr.default.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath),
                },
                s;
            if (n?.adapter) {
                s = qi(n.adapter);
        ...
        $queryRawTyped(n) {
            return this._createPrismaPromise((i) => {
                if (!this._hasPreviewFlag("typedSql"))
                    throw new J("`typedSql` preview feature must be enabled in order to access $queryRawTyped API", {
                        clientVersion: this._clientVersion,
                    });
