                ...
                return (
                    ...
                    a.length === 0 && o === !1
                        ...
                        : a.length === 0 && o === !0
                          ...
                          : s((g, T) => (o ? T <= u : T >= u) && this[T] === a[0] && a.every((O, A) => this[T + A] === O))
                );
            }
...
function cn(e, t) {
    ...
    for (t == null ? ((U = !1), (a = C)) : (a = t), s = new T(0.03125); e.abs().gte(0.1); ) ((e = e.times(s)), (g += 5));
...
function D(e, t, r) {
    ...
    if (
        ...
        return (
            u
                ? ((o = $(e)), (C.length = 1), (t = t - o - 1), (C[0] = Se(10, (N - (t % N)) % N)), (e.e = Ue(-t / N) || 0))
    ...
    if (
        (n == 0
            ? ((C.length = T), (o = 1), T--)
            : ((C.length = T + 1), (o = Se(10, N - n)), (C[T] = i > 0 ? (((g / Se(10, s - i)) % Se(10, i)) | 0) * o : 0)),
        u)
    )
        for (;;)
            if (T == 0) {
...
var Ne,
    ...
    dn = se(() => {
        ...
        R.toDecimalPlaces = R.todp = function (e, t) {
            ...
            return (
                (r = new n(r)),
                e === void 0 ? r : (le(e, 0, Ne), t === void 0 ? (t = n.rounding) : le(t, 0, 8), D(r, e + $(r) + 1, t))
            );
        };
        ...
        R.toSignificantDigits = R.tosd = function (e, t) {
            var r = this,
                n = r.constructor;
            return (
                e === void 0 ? ((e = n.precision), (t = n.rounding)) : (le(e, 1, Ne), t === void 0 ? (t = n.rounding) : le(t, 0, 8)),
                D(new n(r), e, t)
            );
        };
        R.toString =
                        ...
                        ((T = 0),
                            ...
                            a < 0
                                ? ((ne = S[0]),
                                  ...
                                  O < I && C.unshift(0),
                                  r(S, C, I),
                                  a == -1 && ((I = S.length), (a = t(q, S, ie, I)), a < 1 && (T++, r(S, ie < I ? St : q, I))),
                                  (I = S.length))
                                : a === 0 && (T++, (S = [0])),
                            (M[g++] = T),
...
var Pr,
    ...
    Pn = !0;
typeof h < "u" &&
    (({ FORCE_COLOR: Pr, NODE_DISABLE_COLORS: wn, NO_COLOR: En, TERM: xn } = h.env || {}), (Pn = h.stdout && h.stdout.isTTY));
...
var Ps = { red: qe, gray: Sn, dim: Ft, bold: Dt, underline: vn, highlightSource: (e) => e.highlight() },
    vs = { red: (e) => e, gray: (e) => e, dim: (e) => e, bold: (e) => e, underline: (e) => e, highlightSource: (e) => e };
    ...
    return o && u
        ...
        : ((u = s?.getField(n)),
          s && u
              ...
              : ((u = a?.getField(n)),
                a && u ? { parentKind: "omit", field: u, parent: a, fieldName: n } : { parentKind: "unknown", fieldName: n }));
}
function ri(e, t) {
...
function zt({ args: e, errors: t, errorFormat: r, callsite: n, originalMethod: i, clientVersion: o, globalOmit: s }) {
    ...
    let { message: u, args: g } = Ht(a, r),
        T = Je({ message: u, callsite: n, originalMethod: i, showColors: r === "pretty", callArguments: g });
...
function Dr(e, t) {
    e === void 0 &&
        t.isPreviewFeatureOn("strictUndefinedChecks") &&
        t.throwValidationError({ kind: "InvalidSelectionValue", selectionPath: t.getSelectionPath(), underlyingError: pi });
}
var _r = class e {
    constructor(t) {
        this.params = t;
...
function ir({ error: e, user_facing_error: t }, r, n) {
    return t.error_code
        ? new J(ya(t, n), { code: t.error_code, clientVersion: r, meta: t.meta, batchRequestIdx: t.batch_request_idx })
...
function tt(e = {}) {
    let t = wa(e);
    return Object.entries(t).reduce((n, [i, o]) => (Ri[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o), n), {
        select: {},
    });
}
function wa(e = {}) {
...
var Ii = (e) => (Array.isArray(e) ? e : e.split(".")),
    ...
    Li = (e, t, r) => Ii(t).reduceRight((n, i, o, s) => Object.assign({}, Jr(e, s.slice(0, o)), { [i]: n }), r);
function Ta(e, t) {
...
function Wr(e, t) {
    let r = e._extensions.getAllModelExtensions(t) ?? {},
        n = [ka(e, t), Ia(e, t), vt(r), H("name", () => t), H("$name", () => t), H("$parent", () => e._appliedParent)];
    return ge({}, n);
}
function ka(e, t) {
    let r = pe(t),
...
function sr({ visitor: e, result: t, args: r, runtimeDataModel: n, modelName: i }) {
    ...
    let o = e(t, i, r) ?? t;
    return (
        r.include && qi({ includeOrSelect: r.include, result: o, parentModelName: i, runtimeDataModel: n, visitor: e }),
        r.select && qi({ includeOrSelect: r.select, result: o, parentModelName: i, runtimeDataModel: n, visitor: e }),
        o
    );
}
...
function Ct(e) {
    ...
    if (typeof e == "object") {
        ...
        for (let r in e)
            r === "__proto__"
                ? Object.defineProperty(t, r, { value: Ct(e[r]), configurable: !0, enumerable: !0, writable: !0 })
                : (t[r] = Ct(e[r]));
        return t;
    }
    be(e, "Unknown value");
...
${a.backtrace}`,
        ...
        async requestBatch(t, { transaction: r, traceparent: n }) {
            ...
            (await this.start(),
                ...
                (this.executingQueryPromise = this.engine.query(this.lastQuery, JSON.stringify({ traceparent: n }), Zi(r))));
...
function to({ copyEngine: e = !0 }, t) {
    ...
    e &&
        n &&
        ct("recommend--no-engine", "In production, we recommend using `prisma generate --no-engine` (See: `prisma generate --help`)");
        ...
        constructor(t, r) {
            ((this.logEmitter = r),
                ...
                (this.dataloader = new pr({
                    ...
                    batchBy: (n) => (n.transaction?.id ? `transaction-${n.transaction.id}` : bo(n.protocolQuery)),
                    batchOrder(n, i) {
            ...
            let i = n.middlewareArgsMapper ?? il,
                ...
                u = async (g) => {
                    ...
                    let { runInTransaction: C, args: O, ...A } = g,
                        M = { ...n, ...A };
                    (O && (M.args = i.middlewareArgsToRequestArgs(O)), n.transaction !== void 0 && C === !1 && delete M.transaction);
